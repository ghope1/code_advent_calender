% Part 2 of Code Advent Calendar Day 6: https://adventofcode.com/2022/day/6#part2
%
MSG_LEN = 14;  %length of unique character message
...
if numel(unique(dataStream)) == MSG_LEN %check initial queue for unique set
    disp("The index of the first unique set is:")
    disp(i)
    return
end
